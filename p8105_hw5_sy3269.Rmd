...
However, from $\mu$ equal to or greater than 3, the true $\mu$ and the estimate mu became approximately equal. It can be inferred that there is a greater variability when the $\mu$ is smaller. 
