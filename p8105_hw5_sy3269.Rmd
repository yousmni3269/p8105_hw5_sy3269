...
Then, a plot showing the average estimate of $\mu$ on the y axis and teh true value of $\mu$ on the x axis was made. Only the estimates of $\mu$ for which the null was rejected were graphed. 
...
The sample average estimate of $\mu$ across tests for which the null is rejected is not approximately equal to the true value of $\mu$ and this is because of selection bias and conditional inference. 

However, from $\mu$ equal to or greater than 3, the true $\mu$ and the estimate mu became approximately equal. There is a greater variability when the $\mu$ is smaller. 
